...
const getDescansosRangoHandler = async (req, res) => {
    ...
    const { page = 1, limit = 20, search, subgerencia, turno, cargo, regimen, lugar, sexo, dni, funcion, area } = req.query;
    const filters = { search, subgerencia, turno, cargo, regimen, lugar, sexo, dni, funcion, area };
    const errores = [];
