...
rutas.get('/pagos/', permisoAutorizacion(["all_system_access", "read_empleado_pagos"]), getAllEmpleadosPagosHandler);
rutas.get('/:id',permisoAutorizacion(["all_system_access", "read_empleado"]), getEmpleadoHandler);
rutas.get('/pagos/:id',permisoAutorizacion(["all_system_access", "read_empleado_pagos"]), getEmpleadoPagoHandler);
...
rutas.patch('/pagos/:id', permisoAutorizacion(["all_system_access", "update_empleado_pagos"]), uploadImageAndPdf, multerError, updateEmpleadoPagoHandler)
